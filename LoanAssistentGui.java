	...
	private void btnComputePaymentActionListener(ActionEvent e) {
		...
		if(computePayment) {
			...
			if(validateInput(text3)) {
				...
				if(numberOfPayment<3 || numberOfPayment>120) {
					if(JOptionPane.showConfirmDialog(null, "Number of Payment should be Min 3 and Max 120"+
							"\nDo You Want to choose minimum Payment?","Input Error"
							,JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE)==JOptionPane.YES_OPTION) {
						text3.setText("3");
						numberOfPayment=Integer.valueOf(text3.getText());
					}
					else {
						text3.setText("");
						text3.requestFocus();
